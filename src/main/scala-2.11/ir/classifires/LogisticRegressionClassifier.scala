 ...
 */
class LogisticRegressionClassifier(allTrainVectors: Map[String,Map[String,Int]],ally:Map[String,Int],alphap:Double,alpham:Double,steps:Int=1000,debug:Boolean=false) extends Classifier {
